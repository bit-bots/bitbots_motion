...
WalkNode::WalkNode(const std::string ns, std::vector<rclcpp::Parameter> parameters) :
  ...
  step_sub_ = this->create_subscription<geometry_msgs::msg::Twist>("step", 1, std::bind(&WalkNode::stepCb, this, _1));//, options);
  cmd_vel_sub_ =
      this->create_subscription<geometry_msgs::msg::Twist>("cmd_vel", 1, std::bind(&WalkNode::cmdVelCb, this, _1));//, options);
  ...
  joint_state_sub_ = this->create_subscription<sensor_msgs::msg::JointState>("joint_states",
                                                                             ...
                                                                             std::bind(&WalkNode::jointStateCb,
                                                                                       this,
                                                                                       _1));//, options);
  kick_sub_ = this->create_subscription<std_msgs::msg::Bool>("kick", 1, std::bind(&WalkNode::kickCb, this, _1));//, options);
  imu_sub_ = this->create_subscription<sensor_msgs::msg::Imu>("imu/data", 1, std::bind(&WalkNode::imuCb, this, _1));//, options);
